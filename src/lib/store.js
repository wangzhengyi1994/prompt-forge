...
const SEED_DATA = [
  ...
  },
  {
    ...
    tags: ['像素', '游戏', '复古', '8bit'],
    date: '2025-02-12',
    prompt: '像素风格游戏图标，主体为宝箱和金币，8bit复古色彩，明亮饱和的像素色块。等轴侧视角，黑色描边，干净纯色背景。参考经典RPG游戏道具风格，无抗锯齿，保持像素锐利边缘。16x放大渲染，4K分辨率。',
    structure: '风格: 像素8bit | 主体: 宝箱金币 | 色彩: 明亮饱和 | 视角: 等轴侧 | 约束: 无抗锯齿 | 分辨率: 4K',
    template: '像素风格游戏图标，主体为{主体内容}，8bit复古色彩。等轴侧视角，黑色描边，{背景}背景。无抗锯齿，{分辨率}。',
    thumbnail: 'linear-gradient(135deg, #2d1b69 0%, #f64f59 50%, #ffd700 100%)',
  },
  {
    id: '22',
    title: '新拟态风格UI图标',
    ...
    tags: ['新拟态', 'neumorphism', 'UI', '柔和'],
    date: '2025-02-15',
    prompt: '新拟态风格UI图标，主体为播放器控制按钮（播放、暂停、前进、后退），浅灰色背景上的凹凸质感。柔和内阴影与外阴影组合，圆角矩形载体，单色系灰白配色，微妙的高光边缘。正面平视，Figma风格渲染，4K分辨率，极简无多余装饰。',
    structure: '风格: 新拟态 | 主体: 播放器按钮 | 色调: 灰白单色 | 视角: 正面 | 质感: 凹凸阴影 | 分辨率: 4K',
    template: '新拟态风格UI图标，主体为{主体内容}，浅灰色背景凹凸质感。柔和阴影，圆角矩形，{色调}配色。正面平视，{分辨率}。',
    thumbnail: 'linear-gradient(135deg, #e0e5ec 0%, #d1d9e6 50%, #f0f0f3 100%)',
  },
  {
    id: '23',
    title: '蒸汽波霓虹图标',
    source: '小红书',
    tags: ['蒸汽波', 'vaporwave', '霓虹', '复古未来'],
    date: '2025-02-18',
    prompt: '蒸汽波风格3D图标，主体为复古电视机和棕榈树，粉紫蓝霓虹渐变色彩。网格地面，落日天空背景，强烈的色彩对比和光晕效果。Chrome金属反射质感，等轴侧视角，C4D+OC渲染，8K分辨率。80年代复古未来主义氛围。',
    structure: '风格: 蒸汽波 | 主体: 电视机+棕榈树 | 色调: 粉紫蓝霓虹 | 元素: 网格+落日 | 渲染: C4D+OC | 分辨率: 8K',
    template: '蒸汽波风格3D图标，主体为{主体内容}，粉紫蓝霓虹渐变。网格地面，Chrome金属反射，{视角}视角，{渲染器}渲染，{分辨率}。',
    thumbnail: 'linear-gradient(135deg, #ff6fd8 0%, #3813c2 50%, #00d4ff 100%)',
  },
  {
    id: '24',
    title: '微缩模型场景图标',
    source: '小红书',
    tags: ['微缩', 'diorama', '场景', '移轴'],
    date: '2025-02-20',
    prompt: '微缩模型场景图标，主体为咖啡店街角，移轴摄影效果模拟微缩感。暖色调灯光从窗户透出，街道上有小人物和自行车。手工模型质感，略带颗粒的胶片色调，俯视45度角。Blender渲染，景深效果突出主体，8K分辨率，干净裁切无多余元素。',
    structure: '风格: 微缩模型 | 主体: 咖啡店街角 | 效果: 移轴+景深 | 色调: 暖色胶片 | 视角: 俯视45度 | 渲染: Blender',
    template: '微缩模型场景图标，主体为{主体内容}，移轴摄影效果。{色调}灯光，手工模型质感，{视角}视角。{渲染器}渲染，景深效果，{分辨率}。',
    thumbnail: 'linear-gradient(135deg, #ffecd2 0%, #fcb69f 50%, #ee9ca7 100%)',
  },
  {
    id: '25',
    title: '等轴侧小房间场景',
    source: '小红书',
    tags: ['等轴侧', 'isometric', '房间', '室内'],
    date: '2025-02-22',
    prompt: '等轴侧视角3D小房间场景图标，主体为程序员工作室，显示器、键盘、咖啡杯、绿植、书架。卡通风格低多边形建模，莫兰迪配色方案，柔和全局光照。截面展示无屋顶，Blender渲染，干净白色背景，16K分辨率，无底座。',
    structure: '风格: 卡通低多边形 | 主体: 程序员工作室 | 色调: 莫兰迪 | 视角: 等轴侧截面 | 渲染: Blender | 分辨率: 16K',
    template: '等轴侧视角3D小房间场景，主体为{主体内容}。卡通风格低多边形，{色调}配色，截面无屋顶。{渲染器}渲染，{背景}背景，{分辨率}。',
    thumbnail: 'linear-gradient(135deg, #a8edea 0%, #fed6e3 50%, #d4fc79 100%)',
  },
  {
    id: '26',
    title: 'App图标设计模板',
    ...
    tags: ['app', '图标', 'iOS', '圆角'],
    date: '2025-02-25',
    prompt: 'iOS风格App图标设计，主体为渐变色火焰符号，圆角正方形载体。从深紫到亮橙的渐变背景，白色简洁线性图形居中。微妙的内发光和投影效果，正面平视视角。矢量风格渲染，超高清细节，干净无多余装饰，符合Apple Human Interface Guidelines。',
    structure: '风格: iOS App图标 | 主体: 火焰符号 | 色调: 紫橙渐变 | 载体: 圆角方形 | 约束: HIG规范 | 视角: 正面',
    template: 'iOS风格App图标，主体为{主体内容}，圆角正方形载体。{色调}渐变背景，白色线性图形居中。正面平视，超高清。',
    thumbnail: 'linear-gradient(135deg, #7028e4 0%, #e5b2ca 50%, #ff5e62 100%)',
  },
  {
    id: '27',
    title: '折纸风格立体图标',
    ...
    tags: ['折纸', '纸艺', '立体', '手工'],
    date: '2025-02-28',
    prompt: '折纸风格3D立体图标，主体为纸鹤和樱花，真实纸张折痕质感和纤维细节。柔和粉白配色，侧光照明突出折叠层次感。等轴侧视角，浅灰色背景，微妙投影。C4D+Redshift渲染，8K分辨率，干净构图，无底座，日式和风氛围。',
    structure: '风格: 折纸纸艺 | 主体: 纸鹤+樱花 | 材质: 真实纸张 | 色调: 粉白 | 光线: 侧光 | 渲染: C4D+Redshift',
    template: '折纸风格3D图标，主体为{主体内容}，纸张折痕质感。{色调}配色，侧光照明，{视角}视角，{背景}背景。{渲染器}渲染，{分辨率}。',
    thumbnail: 'linear-gradient(135deg, #fdfcfb 0%, #e2d1c3 50%, #f5c6aa 100%)',
  },
  {
    id: '28',
    title: '液态金属流体图标',
    ...
    tags: ['液态', '金属', '流体', '抽象'],
    date: '2025-03-01',
    prompt: '液态金属流体3D图标，主体为抽象音符形态的流动金属，镜面反射Chrome质感。彩虹全息色彩映射在金属表面，流畅有机曲线造型。黑色背景突出金属光泽，环境贴图反射studio灯光。斜角透视视角，Blender Cycles渲染，16K分辨率，无底座无多余元素。',
    structure: '风格: 液态金属 | 主体: 音符流体 | 材质: Chrome镜面 | 色调: 全息彩虹 | 背景: 纯黑 | 渲染: Blender Cycles',
    template: '液态金属流体3D图标，主体为{主体内容}的流动金属，Chrome镜面质感。{色调}色彩映射，{背景}背景。{视角}视角，{渲染器}渲染，{分辨率}。',
    thumbnail: 'linear-gradient(135deg, #0c0c0c 0%, #434343 30%, #c0c0c0 50%, #434343 70%, #0c0c0c 100%)',
  },
]
